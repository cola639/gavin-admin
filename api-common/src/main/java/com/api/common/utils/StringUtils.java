...
/**
 * Utility class for String operations. Extends Apache Commons Lang3 {@link
 * org.apache.commons.lang3.StringUtils} with additional features for collections, arrays, masking,
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
  ...
  public static boolean matches(String str, List<String> patterns) {
    return str != null && patterns != null && patterns.stream().anyMatch(p -> isMatch(p, str));
  }
  ...
  public static String padl(final String s, final int size, final char c) {
    ...
    int len = s.length();
    return len <= size ? String.valueOf(c).repeat(size - len) + s : s.substring(len - size);
  }
}
