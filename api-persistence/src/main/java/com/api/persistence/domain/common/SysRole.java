 ...
 *
 * <p>Represents roles within the system, defining access permissions and scope. Roles are used in
 * RBAC (Role-Based Access Control).
 *
 * <p>Features: - JPA annotations for persistence mapping - Validation annotations for role
 * attributes - Relationships with users, menus, and departments
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class SysRole extends BaseEntity {
  ...
  /**
   * Data scope: 1 = All data 2 = Custom data 3 = Department data 4 = Department and sub-departments
   * 5 = Self only
   */
  ...
  /**
   * Check if the given roleId represents the super admin role. By convention, roleId = 1 is
   * considered admin.
   */
